...
import com.breath_of_the_wild_be.service.campingService.CampingResponse;
...
public class ItemsDeserializer extends JsonDeserializer<Items> {
  ...
  @Override
  public CampingResponse.Items deserialize(JsonParser p, DeserializationContext ctxt)
      throws IOException {
    ...
    return p.getCodec().treeToValue(node, CampingResponse.Items.class);
  }
}
